...
**Software Developer | Python & Robotics Aspirant**

I am a developer currently shifting my focus from web-based projects toward the world of hardware. I am moving away from high-level web environments to explore how software interacts with physical systems, specifically through microcontrollers and robotics.
...
* **The Goal:** Building a foundation in C++ to eventually handle performance-heavy robotics tasks.
...
* **Currently working on:** Grasping C++ fundamentals and moving through my first hardware-focused coding exercises.
...
| --- | --- |
| **Languages** | Python (Proficient), C++ (Beginner) |
| **Hardware** | ESP32, Raspberry Pi Pico 2 W |
| **Environment** | Fedora Linux, Wayland, Kitty |
| **Workflow** | Git, CLI-focused, `uv` |
